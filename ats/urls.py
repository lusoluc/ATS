...
urlpatterns = [
    ...
    path('hilfe/bild/<str:name>', views.hilfe_bild, name='hilfe_bild'),
    ...
    path('recruiter/einstellungen/', views.settings_hub, name='settings_hub'),
    path('recruiter/einstellungen/email/', views.mail_settings_page, name='mail_settings'),
